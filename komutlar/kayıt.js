...
.setTitle(`Kayıt İşlemi Tamamlandı`)
    ...
    .addField(`<a:clownpeepo:781441843577356292> **Steam Profil Linki** :`, "**```" + `${hex}` + "```**" + `Olarak Belirtildi`) 
    .addField(`<:peepoGunHolster:781441838845526016> **Hex ID** :`, "**```" + `${steam}` + "```**" + `Olarak Belirtildi`) 
